...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
	if ([self.delegate respondsToSelector:@selector(adScrollViewWillBeginDragging:)]) {
		[self.delegate adScrollViewWillBeginDragging:scrollView];
	}
}
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate {
	if ([self.delegate respondsToSelector:@selector(adScrollViewDidEndDragging:willDecelerate:)]) {
		[self.delegate adScrollViewDidEndDragging:scrollView willDecelerate:decelerate];
	}
}

- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
	if ([self.delegate respondsToSelector:@selector(adScrollViewDidEndDecelerating:)]) {
		[self.delegate adScrollViewDidEndDecelerating:scrollView];
	}
}
