...
-(void)showPhotoPicker:(UINavigationController *)navigationController
{
    ...
    self.photoPickerController.shouldRefreshData = YES;
...
-(void)showAlertViewToController:(UIViewController *)controller
{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提醒" message:[NSString stringWithFormat:@"请在手机的“设置->隐私->照片开启 “ %@ ”访问您的手机相册",app_Name] preferredStyle:UIAlertControllerStyleAlert];
