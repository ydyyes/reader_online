...
-(void)showAlertViewToController:(UIViewController *)controller
{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提醒" message:[NSString stringWithFormat:@"请在手机的“设置->隐私->照片开启 “%@” 访问您的相机",app_Name] preferredStyle:UIAlertControllerStyleAlert];
