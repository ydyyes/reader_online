...
#define Pic_Btn_Selected       [UIImage imageNamed:@"forward_resumes_blue_btn"]
//   图片未选中状态图片
#define Pic_btn_UnSelected       [UIImage imageNamed:@"picture_unselected"]
//   拍照图片
...
// 返回按钮 
#define Back_Btn_Pic         [UIImage imageNamed:@"back_button"]
