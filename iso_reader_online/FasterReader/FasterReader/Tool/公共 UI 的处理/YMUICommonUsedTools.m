...
+ (void)configPropertyWithLabel:(UILabel *)label font:(CGFloat)font lineSpace:(CGFloat)lineSpace maxWidth:(CGFloat)maxWidth lineBreakMode:(NSLineBreakMode)lineBreakMode rangStr1:(NSString *)rangStr1 rangStr2:(NSString *)rangStr2
{
    CGFloat textDefaultMarginHeiht = (label.font.lineHeight-label.font.pointSize);
    lineSpace = lineSpace-textDefaultMarginHeiht;
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:label.text];
...
+ (void)configPropertyWithLabel:(UILabel *)label font:(CGFloat)font lineSpace:(CGFloat)lineSpace maxWidth:(CGFloat)maxWidth lineBreakMode:(NSLineBreakMode)lineBreakMode rangStr1:(NSString *)rangStr1 rangStr2:(NSString *)rangStr2 timeStr:(NSString *)timeStr
{
...
+ (UIImage *)createShareImage:(UIImage *)sourceImage Context:(NSString *)text textFont:(CGFloat)nameFont textColor:(UIColor *)color
{
...
+ (CGFloat)getHeightWithLabel:(UILabel *)label font:(CGFloat)font lineSpace:(CGFloat)lineSpace maxWidth:(CGFloat)maxWidth lineBreakMode:(NSLineBreakMode)lineBreakMode
{
    // NSKernAttributeName:@1.5f
    // CGFloat textDefaultMarginHeiht = (label.font.lineHeight-label.font.pointSize); 当前字体下文本的默认间距
    CGFloat textDefaultMarginHeiht = (label.font.lineHeight-label.font.pointSize);
...
+ (CGFloat)getHeightWithStr:(NSString *)str withFontSize:(CGFloat)fontSize lineSpace:(CGFloat)lineSpace maxWidth:(CGFloat)maxWidth
{
    // NSKernAttributeName:@1.5f
    // CGFloat textDefaultMarginHeiht = (label.font.lineHeight-label.font.pointSize); 当前字体下文本的默认间距
