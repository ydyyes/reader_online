...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [JPTool screenWidth], [JPTool screenHeight])];
    ...
    self.ratioView.layer.borderColor = [UIColor colorWithHexString:@"3cc266"].CGColor;
    self.ratioView.layer.borderWidth = 1.0f;
    self.ratioView.layer.cornerRadius = self.cropFrame.size.height /2.0;
...
- (void)initControlBtn {
    ...
    label.frame = CGRectMake(0, self.view.frame.size.height - 100.0f, self.view.frame.size.width, 50);
    label.backgroundColor = [UIColor clearColor];
    label.textAlignment = NSTextAlignmentCenter;
    label.font = [UIFont systemFontOfSize:14];
    label.text = @"请截取二维码";
    label.textColor = [UIColor colorWithRed:0.73f green:0.73f blue:0.73f alpha:1.00f];
    if (self.tag == 1111) {
        //不隐藏
        label.hidden = NO;
    } else {
