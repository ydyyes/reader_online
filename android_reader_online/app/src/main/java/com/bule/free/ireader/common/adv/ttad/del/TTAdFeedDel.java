...
public class TTAdFeedDel {
    ...
    public TTAdFeedDel(Activity activity, FrameLayout advContainer, Consumer<Boolean> consumer) {
    ...
    public void loadListAd() {
        ...
        AdSlot adSlot = new AdSlot.Builder()
                .setCodeId(Const.INSTANCE.getChannelConfig().getTtad().getFeed_pos_id())
        ...
        mTTAdNative.loadFeedAd(adSlot, new TTAdNative.FeedAdListener() {
            ...
            public void onError(int code, String message) {
                MobclickAgent.onEvent(activity, "ttad_feed_adv_load");
                MobclickAgent.onEvent(activity, "ttad_feed_adv_load_fail");
            ...
            public void onFeedAdLoad(List<TTFeedAd> ads) {
                ...
                MobclickAgent.onEvent(activity, "ttad_feed_adv_load_count", String.valueOf(ads.size()));
                for (int i = 0; i < ads.size(); i++) {
                    MobclickAgent.onEvent(activity, "ttad_feed_adv_load");
                    MobclickAgent.onEvent(activity, "ttad_feed_adv_load_success");
                }
                ...
                ConstraintLayout rootLayout = bannerView.findViewById(R.id.layout_root);
                int advBackgroundColor = ReadBookConfig.INSTANCE.getAdvBackground();
                rootLayout.setBackgroundColor(advBackgroundColor);
                ...
                MobclickAgent.onEvent(activity, "ttad_feed_adv_show");
                //绑定原生广告的数据
    ...
    private void setAdData(View nativeView, TTFeedAd ttFeedAd) {
        ...
        ttFeedAd.registerViewForInteraction((ViewGroup) nativeView, clickViewList, creativeViewList, imgDislike, new TTNativeAd.AdInteractionListener() {
            ...
            public void onAdClicked(View view, TTNativeAd ad) {
                if (ad != null) {
                    MobclickAgent.onEvent(activity, "ttad_feed_adv_click");
