package com.bule.free.ireader.common.library.qmui;
...
//            }
     ...
     *
     * @param activity 需要被处理的 Activity
     * @param type     StatusBarPlaceHolder 类型，对应不同的系统
     */
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (QMUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > dip(App.instance, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > dip(App.instance, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
