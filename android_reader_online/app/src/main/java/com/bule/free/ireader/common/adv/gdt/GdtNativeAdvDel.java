 ...
 */
@Deprecated
public class GdtNativeAdvDel implements NativeExpressAD.NativeExpressADListener {
    final FrameLayout mFlAdvContainer;

    private NativeExpressADView nativeExpressADView;
    private NativeExpressAD nativeExpressAD;
    @Nullable
    private final GdtNativeAdListener mLoadListener;

    /**
     * 如果不展示广告，则返回null
     */
    @Nullable
    public static GdtNativeAdvDel attach(FrameLayout container, GdtNativeAdListener listener) {
        ...
        GdtNativeAdvDel gdtNativeAdvDel = new GdtNativeAdvDel(container, listener);
        Global.INSTANCE.setLastShowChapterEndAdvTime(System.currentTimeMillis());
        gdtNativeAdvDel.addTencentAdv();
        return gdtNativeAdvDel;
    }

    private GdtNativeAdvDel(FrameLayout mFlAdvContainer, GdtNativeAdListener listener) {
...
//        } else {
        nativeExpressAD = new NativeExpressAD(mFlAdvContainer.getContext(), new ADSize(ADSize.FULL_WIDTH, ADSize.AUTO_HEIGHT),
                Const.INSTANCE.getChannelConfig().getGdt().getApp_id(), Const.INSTANCE.getChannelConfig().getGdt().getNative_pos_id(),
...
//        }
    ...
    public void onADLoaded(List<NativeExpressADView> list) {
        ...
        MobclickAgent.onEvent(mFlAdvContainer.getContext(), "adv_show", "gdt_native_adv");
    ...
    public void onADClicked(NativeExpressADView nativeExpressADView) {
        MobclickAgent.onEvent(mFlAdvContainer.getContext(), "adv_click", "gdt_native_adv");
    }
